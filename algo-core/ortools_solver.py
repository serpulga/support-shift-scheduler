...
def solve(input_json, input_json_schema=None, output_json_schema=None,
          write_output_file=True):

    if not input_json_schema:
    ...
    def setup_dataframes():
        ...
        nonlocal min_week_average_hours
        for agent in agents:
